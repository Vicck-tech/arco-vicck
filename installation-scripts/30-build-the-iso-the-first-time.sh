...
newname1="iso_name=ArcoLinux-Victory-$desktop"

oldname2='iso_label="arcolinux'
newname2='iso_label="ArcoLinux-Victory-'$desktop

#os-release
oldname3='NAME="ArcoLinux"'
newname3='NAME=ArcoLinux-Victory-'$desktop

oldname4='ID=ArcoLinux'
newname4='ID=ArcoLinux-Victory-'$desktop

#lsb-release
oldname5='DISTRIB_ID=ArcoLinux'
newname5='DISTRIB_ID=ArcoLinux-Victory-'$desktop

oldname6='DISTRIB_DESCRIPTION="ArcoLinux"'
newname6='DISTRIB_DESCRIPTION=ArcoLinux-Victory-'$desktop

#hostname
oldname7='ArcoLinux'
newname7='ArcoLinux-Victory-'$desktop

#hosts
oldname8='ArcoLinux'
newname8='ArcoLinux-Victory-'$desktop
